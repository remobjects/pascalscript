...
function IDispatchInvoke(Self: IDispatch; PropertySet: Boolean; const Name: tbtString; const Par: {$ifdef Win32}array of TValue{$endif}{$ifdef Win64}TArray<TValue>{$endif}): Variant;
{$ENDIF}
