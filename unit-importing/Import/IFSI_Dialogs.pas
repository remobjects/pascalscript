...
procedure SIRegister_TFindDialog(CL: TIFPSPascalCompiler);
procedure SIRegister_TPrintDialog(CL: TIFPSPascalCompiler);
procedure SIRegister_TPrinterSetupDialog(CL: TIFPSPascalCompiler);
procedure SIRegister_TFontDialog(CL: TIFPSPascalCompiler);
procedure SIRegister_TColorDialog(CL: TIFPSPascalCompiler);
procedure SIRegister_TSaveDialog(CL: TIFPSPascalCompiler);
